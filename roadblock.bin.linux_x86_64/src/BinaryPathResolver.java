...
public class BinaryPathResolver {
	...
	static {
		try {
			...
			URL codonUsageDbPath = FileLocator
					.resolve(FileLocator.find(currentBundle, new Path("resources/atgc/resources/db/codonUsage.db"), Collections.<String, String> emptyMap()));
			...
			URL sqlite4JavaUrl = FileLocator
					.resolve(FileLocator.find(currentBundle, new Path("resources/atgc/resources/sqlite4java/"), Collections.<String, String> emptyMap()));
