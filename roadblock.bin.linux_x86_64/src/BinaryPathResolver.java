...
public class BinaryPathResolver {
	...
	static {
		try {
			...
			URL ngssBinaryUrl = FileLocator.resolve(FileLocator.find(currentBundle, new Path("resources/ngss/ngss"), Collections.EMPTY_MAP));
			URL ngssUrl = FileLocator.resolve(FileLocator.find(currentBundle, new Path("resources/ngss/ngssWrapper.sh"), Collections.EMPTY_MAP));
