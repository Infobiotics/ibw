 ...
 * <ul>
 * <li>{@link roadblock.emf.ibl.Ibl.BinaryStateFormula#getLeftOperand <em>Left
 * Operand</em>}</li>
 * <li>{@link roadblock.emf.ibl.Ibl.BinaryStateFormula#getRightOperand <em>Right
 * Operand</em>}</li>
 * <li>{@link roadblock.emf.ibl.Ibl.BinaryStateFormula#getOperator <em>Operator
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class BinaryStateFormula extends EObjectImpl implements IStateFormula {
	...
	public NotificationChain basicSetLeftOperand(IStateFormula newLeftOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IblPackage.BINARY_STATE_FORMULA__LEFT_OPERAND,
	 ...
	 * {@link roadblock.emf.ibl.Ibl.BinaryStateFormula#getLeftOperand
	...
	public void setLeftOperand(IStateFormula newLeftOperand) {
		if (newLeftOperand != leftOperand) {
			...
			if (leftOperand != null)
				msgs = ((InternalEObject) leftOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IblPackage.BINARY_STATE_FORMULA__LEFT_OPERAND,
						null, msgs);
			if (newLeftOperand != null)
				msgs = ((InternalEObject) newLeftOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IblPackage.BINARY_STATE_FORMULA__LEFT_OPERAND,
						null, msgs);
	...
	public NotificationChain basicSetRightOperand(IStateFormula newRightOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IblPackage.BINARY_STATE_FORMULA__RIGHT_OPERAND,
	...
	/**
	 * Sets the value of the '
	 * {@link roadblock.emf.ibl.Ibl.BinaryStateFormula#getRightOperand
	 * <em>Right Operand</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
	...
	public void setRightOperand(IStateFormula newRightOperand) {
		if (newRightOperand != rightOperand) {
			...
			if (rightOperand != null)
				msgs = ((InternalEObject) rightOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IblPackage.BINARY_STATE_FORMULA__RIGHT_OPERAND,
						null, msgs);
			if (newRightOperand != null)
				msgs = ((InternalEObject) newRightOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IblPackage.BINARY_STATE_FORMULA__RIGHT_OPERAND,
						null, msgs);
	 ...
	 * {@link roadblock.emf.ibl.Ibl.BooleanOperator}. <!-- begin-user-doc -->
	 * <p>
