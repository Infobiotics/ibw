...
# C. Ladroue
rm -f partRegistry.db
echo "Creating the Database"
echo "CREATE TABLE partRegistry(ID INTEGER PRIMARY KEY AUTOINCREMENT, Name VARCHAR(50), BiologicalFunction VARCHAR(50), Sequence TEXT, Notes TEXT,Origin TEXT);" | sqlite3 partRegistry.db
echo "Adding Roadblock's parts"
cat roadblockParts.sql | sqlite3 partRegistry.db
