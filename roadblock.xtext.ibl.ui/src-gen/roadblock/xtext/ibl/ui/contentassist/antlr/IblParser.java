		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyDefinitionAccess().getGroup_0(), "rule__PropertyDefinition__Group_0__0");
					put(grammarAccess.getPropertyDefinitionAccess().getGroup_1(), "rule__PropertyDefinition__Group_1__0");
					...
					put(grammarAccess.getPropertyDefinitionAccess().getNameAssignment_0_2(), "rule__PropertyDefinition__NameAssignment_0_2");
					put(grammarAccess.getPropertyDefinitionAccess().getArgumentsAssignment_0_4(), "rule__PropertyDefinition__ArgumentsAssignment_0_4");
					put(grammarAccess.getPropertyDefinitionAccess().getArgumentsAssignment_1_1(), "rule__PropertyDefinition__ArgumentsAssignment_1_1");
				}
			};
		}
