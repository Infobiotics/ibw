		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyDefinitionAccess().getAlternatives(), "rule__PropertyDefinition__Alternatives");
					put(grammarAccess.getVerificationStatementAccess().getAlternatives(), "rule__VerificationStatement__Alternatives");
					put(grammarAccess.getVerificationStatementAccess().getAlternatives_1_5(), "rule__VerificationStatement__Alternatives_1_5");
					put(grammarAccess.getPropertyOperatorAccess().getAlternatives(), "rule__PropertyOperator__Alternatives");
					put(grammarAccess.getPropertyLogicalOperatorAccess().getAlternatives(), "rule__PropertyLogicalOperator__Alternatives");
					...
					put(grammarAccess.getPropertyRelationalOperatorAccess().getAlternatives(), "rule__PropertyRelationalOperator__Alternatives");
					...
					put(grammarAccess.getProcessDeclarationAccess().getGroup_6(), "rule__ProcessDeclaration__Group_6__0");
					put(grammarAccess.getProcessDeclarationAccess().getGroup_6_1(), "rule__ProcessDeclaration__Group_6_1__0");
					...
					put(grammarAccess.getVerificationStatementAccess().getGroup_0(), "rule__VerificationStatement__Group_0__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_0_2(), "rule__VerificationStatement__Group_0_2__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_0_2_2(), "rule__VerificationStatement__Group_0_2_2__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_1(), "rule__VerificationStatement__Group_1__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_1_5_0(), "rule__VerificationStatement__Group_1_5_0__0");
					...
					put(grammarAccess.getProcessDeclarationAccess().getNameAssignment_2(), "rule__ProcessDeclaration__NameAssignment_2");
					put(grammarAccess.getProcessDeclarationAccess().getConstructorAssignment_4(), "rule__ProcessDeclaration__ConstructorAssignment_4");
					put(grammarAccess.getProcessDeclarationAccess().getParametersAssignment_6_0(), "rule__ProcessDeclaration__ParametersAssignment_6_0");
					put(grammarAccess.getProcessDeclarationAccess().getParametersAssignment_6_1_1(), "rule__ProcessDeclaration__ParametersAssignment_6_1_1");
					...
					put(grammarAccess.getPropertyStatementAccess().getNameAssignment_2(), "rule__PropertyStatement__NameAssignment_2");
					put(grammarAccess.getPropertyStatementAccess().getArgumentsAssignment_4(), "rule__PropertyStatement__ArgumentsAssignment_4");
					put(grammarAccess.getVerificationStatementAccess().getPropertyAssignment_0_2_1(), "rule__VerificationStatement__PropertyAssignment_0_2_1");
					put(grammarAccess.getVerificationStatementAccess().getPropertyAssignment_0_2_2_1(), "rule__VerificationStatement__PropertyAssignment_0_2_2_1");
					put(grammarAccess.getVerificationStatementAccess().getConditionAssignment_0_2_4(), "rule__VerificationStatement__ConditionAssignment_0_2_4");
					put(grammarAccess.getVerificationStatementAccess().getNameAssignment_1_1(), "rule__VerificationStatement__NameAssignment_1_1");
					put(grammarAccess.getVerificationStatementAccess().getTimeAssignment_1_3(), "rule__VerificationStatement__TimeAssignment_1_3");
					put(grammarAccess.getVerificationStatementAccess().getOperatorAssignment_1_5_0_0(), "rule__VerificationStatement__OperatorAssignment_1_5_0_0");
					put(grammarAccess.getVerificationStatementAccess().getConcentrationAssignment_1_5_0_1(), "rule__VerificationStatement__ConcentrationAssignment_1_5_0_1");
