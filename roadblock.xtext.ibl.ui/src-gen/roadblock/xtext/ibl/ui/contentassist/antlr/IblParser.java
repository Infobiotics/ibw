		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcessParameterScopeAccess().getAlternatives(), "rule__ProcessParameterScope__Alternatives");
					put(grammarAccess.getProcessDefinitionMemberAccess().getAlternatives(), "rule__ProcessDefinitionMember__Alternatives");
					...
					put(grammarAccess.getProcessDefinitionAccess().getGroup_5(), "rule__ProcessDefinition__Group_5__0");
					put(grammarAccess.getProcessDefinitionAccess().getGroup_5_1(), "rule__ProcessDefinition__Group_5_1__0");
					put(grammarAccess.getProcessDefinitionAccess().getGroup_10(), "rule__ProcessDefinition__Group_10__0");
					put(grammarAccess.getProcessDefinitionAccess().getGroup_10_2(), "rule__ProcessDefinition__Group_10_2__0");
					put(grammarAccess.getProcessParameterMemberAccess().getGroup(), "rule__ProcessParameterMember__Group__0");
					put(grammarAccess.getProcessUseMemberAccess().getGroup(), "rule__ProcessUseMember__Group__0");
					put(grammarAccess.getProcessCallAccess().getGroup(), "rule__ProcessCall__Group__0");
					put(grammarAccess.getProcessCallAccess().getGroup_6(), "rule__ProcessCall__Group_6__0");
					put(grammarAccess.getProcessCallAccess().getGroup_6_1(), "rule__ProcessCall__Group_6_1__0");
					...
					put(grammarAccess.getProcessDefinitionAccess().getNameAssignment_3(), "rule__ProcessDefinition__NameAssignment_3");
					put(grammarAccess.getProcessDefinitionAccess().getParametersAssignment_5_0(), "rule__ProcessDefinition__ParametersAssignment_5_0");
					put(grammarAccess.getProcessDefinitionAccess().getParametersAssignment_5_1_1(), "rule__ProcessDefinition__ParametersAssignment_5_1_1");
					put(grammarAccess.getProcessDefinitionAccess().getMembersAssignment_8(), "rule__ProcessDefinition__MembersAssignment_8");
					put(grammarAccess.getProcessDefinitionAccess().getUsesAssignment_10_1(), "rule__ProcessDefinition__UsesAssignment_10_1");
					put(grammarAccess.getProcessDefinitionAccess().getUsesAssignment_10_2_1(), "rule__ProcessDefinition__UsesAssignment_10_2_1");
					put(grammarAccess.getProcessParameterMemberAccess().getTypeAssignment_1(), "rule__ProcessParameterMember__TypeAssignment_1");
					put(grammarAccess.getProcessParameterMemberAccess().getNameAssignment_2(), "rule__ProcessParameterMember__NameAssignment_2");
					put(grammarAccess.getProcessParameterMemberAccess().getScopeAssignment_4(), "rule__ProcessParameterMember__ScopeAssignment_4");
					put(grammarAccess.getProcessUseMemberAccess().getTypeAssignment_1(), "rule__ProcessUseMember__TypeAssignment_1");
					put(grammarAccess.getProcessUseMemberAccess().getNameAssignment_2(), "rule__ProcessUseMember__NameAssignment_2");
					put(grammarAccess.getProcessCallAccess().getNameAssignment_2(), "rule__ProcessCall__NameAssignment_2");
					put(grammarAccess.getProcessCallAccess().getConstructorAssignment_4(), "rule__ProcessCall__ConstructorAssignment_4");
					put(grammarAccess.getProcessCallAccess().getParametersAssignment_6_0(), "rule__ProcessCall__ParametersAssignment_6_0");
					put(grammarAccess.getProcessCallAccess().getParametersAssignment_6_1_1(), "rule__ProcessCall__ParametersAssignment_6_1_1");
