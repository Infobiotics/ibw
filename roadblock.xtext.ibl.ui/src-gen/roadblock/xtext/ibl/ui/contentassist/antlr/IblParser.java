		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBooleanOperatorAccess().getGroup_4(), "rule__BooleanOperator__Group_4__0");
					put(grammarAccess.getBooleanOperatorAccess().getGroup_5(), "rule__BooleanOperator__Group_5__0");
					...
					put(grammarAccess.getVariableDefinitionBuiltInAccess().getNameAssignment_2(), "rule__VariableDefinitionBuiltIn__NameAssignment_2");
