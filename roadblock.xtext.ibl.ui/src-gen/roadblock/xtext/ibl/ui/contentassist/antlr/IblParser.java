		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVerificationStatementAccess().getAlternatives_2(), "rule__VerificationStatement__Alternatives_2");
					put(grammarAccess.getVerificationStatementAccess().getAlternatives_2_1_7(), "rule__VerificationStatement__Alternatives_2_1_7");
					...
					put(grammarAccess.getVerificationStatementAccess().getGroup(), "rule__VerificationStatement__Group__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_2_0(), "rule__VerificationStatement__Group_2_0__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_2_0_2(), "rule__VerificationStatement__Group_2_0_2__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_2_1(), "rule__VerificationStatement__Group_2_1__0");
					put(grammarAccess.getVerificationStatementAccess().getGroup_2_1_7_0(), "rule__VerificationStatement__Group_2_1_7_0__0");
					...
					put(grammarAccess.getVerificationStatementAccess().getPropertyAssignment_2_0_1(), "rule__VerificationStatement__PropertyAssignment_2_0_1");
					put(grammarAccess.getVerificationStatementAccess().getPropertyAssignment_2_0_2_1(), "rule__VerificationStatement__PropertyAssignment_2_0_2_1");
					put(grammarAccess.getVerificationStatementAccess().getConditionAssignment_2_0_4(), "rule__VerificationStatement__ConditionAssignment_2_0_4");
					put(grammarAccess.getVerificationStatementAccess().getNameAssignment_2_1_2(), "rule__VerificationStatement__NameAssignment_2_1_2");
					put(grammarAccess.getVerificationStatementAccess().getTimeAssignment_2_1_5(), "rule__VerificationStatement__TimeAssignment_2_1_5");
					put(grammarAccess.getVerificationStatementAccess().getOperatorAssignment_2_1_7_0_0(), "rule__VerificationStatement__OperatorAssignment_2_1_7_0_0");
					put(grammarAccess.getVerificationStatementAccess().getConcentrationAssignment_2_1_7_0_1(), "rule__VerificationStatement__ConcentrationAssignment_2_1_7_0_1");
