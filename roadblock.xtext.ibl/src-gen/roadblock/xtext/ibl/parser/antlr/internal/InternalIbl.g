...
(
    ...
    { 
        $current = $this_VariableDefinition_3.current; 
        afterParserOrEnumRuleCall();
    }
...
(
    ...
    { 
        $current = $this_VariableName_0.current; 
        afterParserOrEnumRuleCall();
    }
